...
## Separated Project Boundary

Smart Health Cabin collaboration material now lives in the sibling workspace:

```text
../imedtac-smart-health-cabin-v0
```

That project owns the `2026-06-17` Smart Health Cabin requirements, the
`2026-06-19` Prof. Wu / Tomi Smart Health Cabin sync, the `2026-06-23` onsite
visit transcript, Prof. Wu's HPA adult preventive health form source, and the
questionnaire MVP design note. This source index keeps only AI triage kiosk demo
sources and direct API/demo context.
