...
| `2026-06-23` | `workstreams/smart-health-cabin/hpa-adult-preventive-health-questionnaire-mvp-design-note.md` | Expert analysis and MVP design note for the HPA adult preventive health questionnaire path. Records the source strategy that the system should not invent questionnaires: use the HPA adult preventive health form as the Taiwan public-sector backbone, WHO STEPS as the international public-health backbone, then add standardized modules by age and service context. Defines MVP scope as HPA red-box fields, WHO STEPS core simplified risk-factor fields, PHQ-2, and basic height / weight / waist / blood pressure / vision / hearing measurement outputs, with report wording limited to health measurement summary and public-health risk self-assessment. |
